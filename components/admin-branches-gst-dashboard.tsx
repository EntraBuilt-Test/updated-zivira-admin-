...
<tr className="bg-surface-subtle/80 border-b border-border-subtle text-text-secondary font-bold uppercase text-[11px] tracking-wider hover:bg-surface-subtle/50 transition-colors group">
<th className="px-4 py-3 text-xs font-semibold text-text-secondary uppercase tracking-wider whitespace-nowrap border-b border-border-subtle bg-surface-subtle">Depot &amp; Location</th>
<th className="px-4 py-3 text-xs font-semibold text-text-secondary uppercase tracking-wider whitespace-nowrap border-b border-border-subtle bg-surface-subtle">GSTIN &amp; Code</th>
<th className="px-4 py-3 text-xs font-semibold text-text-secondary uppercase tracking-wider whitespace-nowrap border-b border-border-subtle bg-surface-subtle">Infra &amp; Cold Chain</th>
<th className="px-4 py-3 text-xs font-semibold text-text-secondary uppercase tracking-wider whitespace-nowrap border-b border-border-subtle bg-surface-subtle">MTD Primary Sales</th>
<th className="px-4 py-3 text-xs font-semibold text-text-secondary uppercase tracking-wider whitespace-nowrap border-b border-border-subtle bg-surface-subtle">Branch Leadership</th>
<th className="px-4 py-3 text-xs font-semibold text-text-secondary uppercase tracking-wider whitespace-nowrap border-b border-border-subtle bg-surface-subtle">Status &amp; Actions</th>
</tr>
</thead>
<tbody className="divide-y divide-border-subtle"><tr className="hover:bg-surface-subtle/60 transition-colors group hover:bg-surface-subtle/50 transition-colors group"><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-3"><div className="w-9 h-9 rounded-lg bg-orange-50 border border-orange-200/60 text-[#b43403] flex items-center justify-center font-display font-bold text-xs shrink-0">MH</div><div><div className="font-display font-bold text-text-primary leading-tight">Mumbai Central Depot</div><div className="text-[11px] text-text-secondary flex items-center gap-1 mt-0.5"><span className="material-symbols-outlined text-[13px] text-text-muted">pin_drop</span><span className="">Bhiwandi Hub, MH</span></div></div></div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-mono font-semibold text-text-primary text-[11px]">27AABCZ1234F1Z5</div><div className="text-[10px] text-text-muted font-medium">State: 27-MH</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-medium text-text-primary">45,000 sq ft</div><span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-sky-50 text-sky-700 text-[10px] font-semibold mt-0.5"><span className="material-symbols-outlined text-[11px]">ac_unit</span> Cold-Chain Active</span></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-display font-bold text-text-primary">₹3.42 Cr</div><div className="text-[10px] font-semibold text-emerald-600 flex items-center"><span className="material-symbols-outlined text-[12px]">arrow_upward</span> 98.4% Achv</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-surface-subtle text-text-secondary font-bold text-[10px] flex items-center justify-center">RK</div><div><div className="font-medium text-text-primary leading-tight">Rajesh Kulkarni</div><div className="text-[10px] text-text-muted">VP - West Logistics</div></div></div></td><td className="px-4 py-3.5 text-right text-sm text-text-primary whitespace-nowrap"><div className="flex flex-col items-end gap-1"><span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-status-success-bg text-status-success text-[10px] font-semibold"><span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> GSTR-1 Synced</span><div className="flex items-center gap-1.5 mt-0.5"><button className="text-[11px] font-semibold text-[#b43403] hover:underline" title="Tax Ledger">Tax Ledger</button><span className="text-slate-300">•</span><button className="text-[11px] font-semibold text-text-secondary hover:text-text-primary hover:underline" title="E-Way Bills">E-Way Bills</button></div></div></td></tr><tr className="hover:bg-surface-subtle/60 transition-colors group hover:bg-surface-subtle/50 transition-colors group"><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-3"><div className="w-9 h-9 rounded-lg bg-orange-50 border border-orange-200/60 text-[#b43403] flex items-center justify-center font-display font-bold text-xs shrink-0">KA</div><div><div className="font-display font-bold text-text-primary leading-tight">Bengaluru Distribution Hub</div><div className="text-[11px] text-text-secondary flex items-center gap-1 mt-0.5"><span className="material-symbols-outlined text-[13px] text-text-muted">pin_drop</span><span className="">Peenya Industrial, KA</span></div></div></div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-mono font-semibold text-text-primary text-[11px]">29AABCZ1234F1Z3</div><div className="text-[10px] text-text-muted font-medium">State: 29-KA</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-medium text-text-primary">32,000 sq ft</div><span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-sky-50 text-sky-700 text-[10px] font-semibold mt-0.5"><span className="material-symbols-outlined text-[11px]">ac_unit</span> Pharma Cold</span></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-display font-bold text-text-primary">₹2.85 Cr</div><div className="text-[10px] font-semibold text-emerald-600 flex items-center"><span className="material-symbols-outlined text-[12px]">arrow_upward</span> 104.2% Achv</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-surface-subtle text-text-secondary font-bold text-[10px] flex items-center justify-center">SB</div><div><div className="font-medium text-text-primary leading-tight">Suresh Babu</div><div className="text-[10px] text-text-muted">AVP - South Operations</div></div></div></td><td className="px-4 py-3.5 text-right text-sm text-text-primary whitespace-nowrap"><div className="flex flex-col items-end gap-1"><span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-status-success-bg text-status-success text-[10px] font-semibold"><span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> GSTR-1 Synced</span><div className="flex items-center gap-1.5 mt-0.5"><button className="text-[11px] font-semibold text-[#b43403] hover:underline">Tax Ledger</button><span className="text-slate-300">•</span><button className="text-[11px] font-semibold text-text-secondary hover:text-text-primary hover:underline">E-Way Bills</button></div></div></td></tr><tr className="hover:bg-surface-subtle/60 transition-colors group hover:bg-surface-subtle/50 transition-colors group"><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-3"><div className="w-9 h-9 rounded-lg bg-orange-50 border border-orange-200/60 text-[#b43403] flex items-center justify-center font-display font-bold text-xs shrink-0">DL</div><div><div className="font-display font-bold text-text-primary leading-tight">Delhi North Super-Depot</div><div className="text-[11px] text-text-secondary flex items-center gap-1 mt-0.5"><span className="material-symbols-outlined text-[13px] text-text-muted">pin_drop</span><span className="">Okhla Phase II, DL</span></div></div></div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-mono font-semibold text-text-primary text-[11px]">07AABCZ1234F1Z9</div><div className="text-[10px] text-text-muted font-medium">State: 07-DL</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-medium text-text-primary">38,000 sq ft</div><span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-surface-subtle text-text-secondary text-[10px] font-semibold mt-0.5"><span className="material-symbols-outlined text-[11px]">inventory_2</span> Ambient &amp; Cool</span></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-display font-bold text-text-primary">₹3.10 Cr</div><div className="text-[10px] font-semibold text-amber-600 flex items-center"><span className="material-symbols-outlined text-[12px]">trending_flat</span> 92.1% Achv</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-surface-subtle text-text-secondary font-bold text-[10px] flex items-center justify-center">AS</div><div><div className="font-medium text-text-primary leading-tight">Amitav Sen</div><div className="text-[10px] text-text-muted">Zonal Director - North</div></div></div></td><td className="px-4 py-3.5 text-right text-sm text-text-primary whitespace-nowrap"><div className="flex flex-col items-end gap-1"><span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-status-info-bg text-status-info text-[10px] font-semibold"><span className="w-1.5 h-1.5 rounded-full bg-blue-500"></span> Audit Ready</span><div className="flex items-center gap-1.5 mt-0.5"><button className="text-[11px] font-semibold text-[#b43403] hover:underline">Tax Ledger</button><span className="text-slate-300">•</span><button className="text-[11px] font-semibold text-text-secondary hover:text-text-primary hover:underline">E-Way Bills</button></div></div></td></tr><tr className="hover:bg-surface-subtle/60 transition-colors group hover:bg-surface-subtle/50 transition-colors group"><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-3"><div className="w-9 h-9 rounded-lg bg-orange-50 border border-orange-200/60 text-[#b43403] flex items-center justify-center font-display font-bold text-xs shrink-0">GJ</div><div><div className="font-display font-bold text-text-primary leading-tight">Ahmedabad Logistics Hub</div><div className="text-[11px] text-text-secondary flex items-center gap-1 mt-0.5"><span className="material-symbols-outlined text-[13px] text-text-muted">pin_drop</span><span className="">Sanand GIDC, GJ</span></div></div></div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-mono font-semibold text-text-primary text-[11px]">24AABCZ1234F1Z2</div><div className="text-[10px] text-text-muted font-medium">State: 24-GJ</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-medium text-text-primary">28,000 sq ft</div><span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-sky-50 text-sky-700 text-[10px] font-semibold mt-0.5"><span className="material-symbols-outlined text-[11px]">ac_unit</span> Dual-Temp Certified</span></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-display font-bold text-text-primary">₹2.15 Cr</div><div className="text-[10px] font-semibold text-emerald-600 flex items-center"><span className="material-symbols-outlined text-[12px]">arrow_upward</span> 101.8% Achv</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-surface-subtle text-text-secondary font-bold text-[10px] flex items-center justify-center">BP</div><div><div className="font-medium text-text-primary leading-tight">Bhavesh Patel</div><div className="text-[10px] text-text-muted">Regional Logistics Head</div></div></div></td><td className="px-4 py-3.5 text-right text-sm text-text-primary whitespace-nowrap"><div className="flex flex-col items-end gap-1"><span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-status-success-bg text-status-success text-[10px] font-semibold"><span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> GSTR-1 Synced</span><div className="flex items-center gap-1.5 mt-0.5"><button className="text-[11px] font-semibold text-[#b43403] hover:underline">Tax Ledger</button><span className="text-slate-300">•</span><button className="text-[11px] font-semibold text-text-secondary hover:text-text-primary hover:underline">E-Way Bills</button></div></div></td></tr><tr className="hover:bg-surface-subtle/60 transition-colors group hover:bg-surface-subtle/50 transition-colors group"><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-3"><div className="w-9 h-9 rounded-lg bg-orange-50 border border-orange-200/60 text-[#b43403] flex items-center justify-center font-display font-bold text-xs shrink-0">WB</div><div><div className="font-display font-bold text-text-primary leading-tight">Kolkata Metro C&amp;F Depot</div><div className="text-[11px] text-text-secondary flex items-center gap-1 mt-0.5"><span className="material-symbols-outlined text-[13px] text-text-muted">pin_drop</span><span className="">Dankuni Complex, WB</span></div></div></div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-mono font-semibold text-text-primary text-[11px]">19AABCZ1234F1Z7</div><div className="text-[10px] text-text-muted font-medium">State: 19-WB</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-medium text-text-primary">25,000 sq ft</div><span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-sky-50 text-sky-700 text-[10px] font-semibold mt-0.5"><span className="material-symbols-outlined text-[11px]">ac_unit</span> Cold Chain Verified</span></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="font-display font-bold text-text-primary">₹1.88 Cr</div><div className="text-[10px] font-semibold text-amber-600 flex items-center"><span className="material-symbols-outlined text-[12px]">trending_flat</span> 96.5% Achv</div></td><td className="px-4 py-3.5 text-sm text-text-primary whitespace-nowrap"><div className="flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-surface-subtle text-text-secondary font-bold text-[10px] flex items-center justify-center">SR</div><div><div className="font-medium text-text-primary leading-tight">Subir Roy</div><div className="text-[10px] text-text-muted">East Logistics Manager</div></div></div></td><td className="px-4 py-3.5 text-right text-sm text-text-primary whitespace-nowrap"><div className="flex flex-col items-end gap-1"><span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-status-warning-bg text-status-warning text-[10px] font-semibold"><span className="w-1.5 h-1.5 rounded-full bg-amber-500"></span> GSTR-3B Pending</span><div className="flex items-center gap-1.5 mt-0.5"><button className="text-[11px] font-semibold text-[#b43403] hover:underline">Tax Ledger</button><span className="text-slate-300">•</span><button className="text-[11px] font-semibold text-text-secondary hover:text-text-primary hover:underline">E-Way Bills</button></div></div></td></tr></tbody>
</table>
</div>
