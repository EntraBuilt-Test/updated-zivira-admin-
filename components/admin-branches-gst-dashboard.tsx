...
<button className="h-9 px-3.5 bg-surface-card hover:bg-surface-subtle border border-border-subtle text-text-secondary text-xs font-semibold rounded-lg flex items-center gap-4 shadow-2xs transition-colors">
...
<div className="flex items-center gap-4 text-[#b43403]"><span className="material-symbols-outlined text-[20px]">badge</span><h3 className="font-display font-bold text-sm text-text-primary">Instant GSTIN Validator</h3></div>
