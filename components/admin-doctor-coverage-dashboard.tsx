...
<div>
<div className="font-bold text-text-primary leading-tight">Dr. Ananya Mukherjee</div>
<div className="text-[11px] text-text-secondary">Cardiology • Fortis Hospital, Kolkata</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div className="text-[10px] text-text-muted">Kolkata East &amp; Salt Lake</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<button className="p-1 hover:bg-slate-200 rounded text-text-muted hover:text-text-secondary transition-colors" title="View Call Details">
...
<div>
<div className="font-bold text-text-primary leading-tight">Dr. Vikram Malhotra</div>
<div className="text-[11px] text-text-secondary">Endocrinology • Max Super Speciality, Delhi</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div className="text-[10px] text-text-muted">Delhi NCR South</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div>
<div className="font-bold text-text-primary leading-tight">Dr. Arvind Rao</div>
<div className="text-[11px] text-text-secondary">Pediatrics • Manipal Hospital, Bengaluru</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div className="text-[10px] text-text-muted">Bengaluru Central Hub</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div>
<div className="font-bold text-text-primary leading-tight">Dr. Sangeeta Kulkarni</div>
<div className="text-[11px] text-text-secondary">Pulmonology • Breach Candy Hospital, Mumbai</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div className="text-[10px] text-text-muted">Mumbai South Metro</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div>
<div className="font-bold text-text-primary leading-tight">Dr. Rajesh Nair</div>
<div className="text-[11px] text-text-secondary">Neurology • Apollo Hospitals, Chennai</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div className="text-[10px] text-text-muted">Chennai Central Hub</div>
</div>
</div>
</td>
<td className="py-3.5 px-4">
...
<div className="text-text-secondary">
            Showing <span className="font-bold text-text-primary">1 to 5</span> of <span className="font-bold text-text-primary">14,820</span> Doctors • <span className="text-rose-600 font-semibold">1,719 doctors require beat intervention</span>
</div>
<div className="flex items-center gap-1.5">
<button className="px-2 py-1 text-text-muted hover:text-text-secondary border border-border-subtle rounded bg-surface-subtle disabled:opacity-50" disabled={true}>
...
<button className="px-2.5 py-1 text-xs font-semibold rounded text-text-secondary hover:bg-surface-subtle">2</button>
<button className="px-2.5 py-1 text-xs font-semibold rounded text-text-secondary hover:bg-surface-subtle">3</button>
<span className="text-text-muted px-1">...</span>
<button className="px-2.5 py-1 text-xs font-semibold rounded text-text-secondary hover:bg-surface-subtle">2,964</button>
<button className="px-2 py-1 text-text-secondary hover:text-text-primary border border-border-subtle rounded bg-surface-card hover:bg-surface-subtle">
...
<button className="px-2 py-1 bg-surface-card border border-rose-300 text-rose-700 hover:bg-rose-50 rounded text-[10px] font-bold shadow-xs whitespace-nowrap">
                  Reassign Beat
                </button>
</div>
{/* Bottleneck Item 2 */}
...
<button className="px-2 py-1 bg-surface-card border border-amber-300 text-status-warning hover:bg-status-warning-bg rounded text-[10px] font-bold shadow-xs whitespace-nowrap">
                  Adjust Route
                </button>
</div>
</div>
