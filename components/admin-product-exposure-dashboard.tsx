    ...
    <header className="bg-white border-b border-slate-200 px-8 py-3.5 flex items-center justify-between sticky top-0 z-20">
      <div className="flex items-center gap-3">
        <div className="text-xs text-slate-400 flex items-center gap-1.5 font-medium">
          ...
          <span>/</span>
          <span className="text-slate-800 font-semibold">Product Exposure & Detailing Analytics</span>
        </div>
      </div>
    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Product Exposure & Brand Detailing Share</h1>
            <span className="bg-blue-50 text-blue-700 border border-blue-200 text-[11px] font-bold px-2.5 py-0.5 rounded-full flex items-center gap-1.5">
          ...
          <p className="text-xs text-slate-500">Track visual aid e-detailing duration, slide engagement, priority brand share-of-voice (SOV), and chemist stockist pull-through.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-2xs">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-extrabold text-slate-900 tracking-tight">10,455</span>
          ...
          <div className="mt-2 pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span className="text-emerald-700 font-semibold">Active Sync</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-2xs">
          <div className="flex items-center justify-between text-xs text-slate-500 font-medium mb-2">
            ...
            <div className="w-7 h-7 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center text-xs"><i className="fa-solid fa-stopwatch"></i></div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-extrabold text-slate-900 tracking-tight">3m 42s</span>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-2xs">
          <div className="flex items-center justify-between text-xs text-slate-500 font-medium mb-2">
            ...
            <div className="w-7 h-7 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center text-xs"><i className="fa-solid fa-chart-pie"></i></div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-extrabold text-slate-900 tracking-tight">68.2%</span>
            <span className="text-[11px] font-bold text-emerald-600">Target ≥65%</span>
          </div>
          <div className="mt-2 pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
            <span>Top 4 Strategic SKUs</span>
            <span className="text-emerald-700 font-semibold">Optimal Split</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-2xs">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-extrabold text-slate-900 tracking-tight">76.4%</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="p-4 border-b border-slate-100 flex flex-wrap items-center justify-between gap-3 bg-slate-50/50">
            <div className="flex items-center gap-2 flex-1 min-w-[240px]">
              <div className="relative w-full">
                ...
                <input type="text" placeholder="Search Brand, Molecule, Therapeutic Category or SKU..." className="w-full bg-white border border-slate-200 rounded-lg pl-8 pr-3 py-1.5 text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:border-slate-400"/>
              </div>
            </div>
              ...
              <tbody className="divide-y divide-slate-100 text-slate-700">
                ...
                <tr className="bg-orange-50/40 hover:bg-orange-50/60 transition-colors">
                  ...
                  <td className="py-3.5 px-3">
                    <div className="font-bold text-slate-900">CardioCare 20mg</div>
                    <div className="text-[11px] text-slate-400 font-mono">Atorvastatin + Aspirin • Tab</div>
                  </td>
                  <td className="py-3.5 px-3">
                  ...
                  <td className="py-3.5 px-3 font-bold text-slate-900">3,420 Calls</td>
                  <td className="py-3.5 px-3 font-semibold text-slate-700">1m 18s</td>
                ...
                <tr className="hover:bg-slate-50/70 transition-colors">
                  ...
                  <td className="py-3.5 px-3">
                    <div className="font-bold text-slate-900">GlycoZiv XR 500</div>
                    <div className="text-[11px] text-slate-400 font-mono">Metformin SR + Dapagliflozin</div>
                  </td>
                  <td className="py-3.5 px-3">
                    <span className="bg-blue-50 text-blue-700 border border-blue-200 text-[10px] font-bold px-2 py-0.5 rounded">Diabetology</span>
                  </td>
                  <td className="py-3.5 px-3">
                    <span className="bg-terracotta text-white font-bold text-[10px] px-2 py-0.5 rounded shadow-2xs">P1 Core</span>
                  </td>
                  <td className="py-3.5 px-3 font-bold text-slate-900">2,890 Calls</td>
                  <td className="py-3.5 px-3 font-semibold text-slate-700">1m 04s</td>
                ...
                <tr className="hover:bg-slate-50/70 transition-colors">
                  <td className="py-3.5 px-3.5"><input type="checkbox" className="rounded border-slate-300 text-terracotta focus:ring-0"/></td>
                  <td className="py-3.5 px-3">
                    <div className="font-bold text-slate-900">Resp-Clear Inhaler 200mcg</div>
                    <div className="text-[11px] text-slate-400 font-mono">Budesonide + Formoterol DPI</div>
                  </td>
                  <td className="py-3.5 px-3">
                    <span className="bg-emerald-50 text-emerald-700 border border-emerald-200 text-[10px] font-bold px-2 py-0.5 rounded">Pulmonology</span>
                  </td>
                  <td className="py-3.5 px-3">
                    <span className="bg-slate-100 text-slate-700 font-bold text-[10px] px-2 py-0.5 rounded">P2 Focus</span>
                  </td>
                  <td className="py-3.5 px-3 font-bold text-slate-900">2,140 Calls</td>
                  <td className="py-3.5 px-3 font-semibold text-slate-700">48s</td>
                ...
                <tr className="hover:bg-slate-50/70 transition-colors">
                  <td className="py-3.5 px-3.5"><input type="checkbox" className="rounded border-slate-300 text-terracotta focus:ring-0"/></td>
                  <td className="py-3.5 px-3">
                    <div className="font-bold text-slate-900">ZiviCal D3 Forte</div>
                    <div className="text-[11px] text-slate-400 font-mono">Cholecalciferol 60,000 IU Softgel</div>
                  </td>
                  <td className="py-3.5 px-3">
                    <span className="bg-amber-50 text-amber-700 border border-amber-200 text-[10px] font-bold px-2 py-0.5 rounded">Orthopedics</span>
                  </td>
                  <td className="py-3.5 px-3">
                    <span className="bg-slate-100 text-slate-700 font-bold text-[10px] px-2 py-0.5 rounded">P2 Focus</span>
                  </td>
                  <td className="py-3.5 px-3 font-bold text-slate-900">1,980 Calls</td>
                  <td className="py-3.5 px-3 font-semibold text-slate-700">42s</td>
                  <td className="py-3.5 px-3 font-bold text-slate-600">+8.2%</td>
                  <td className="py-3.5 px-3 text-right">
                    <span className="text-slate-500 hover:text-slate-800 font-semibold text-[11px] cursor-pointer">Inspect</span>
                  </td>
                </tr>
                ...
                <tr className="hover:bg-slate-50/70 transition-colors">
                  <td className="py-3.5 px-3.5"><input type="checkbox" className="rounded border-slate-300 text-terracotta focus:ring-0"/></td>
                  <td className="py-3.5 px-3">
                    <div className="font-bold text-slate-900">GastroZiv DSR</div>
                    <div className="text-[11px] text-slate-400 font-mono">Rabeprazole 20mg + Domperidone 30mg</div>
                  </td>
                  <td className="py-3.5 px-3">
                  ...
                  <td className="py-3.5 px-3">
                    <span className="bg-slate-50 text-slate-500 font-bold text-[10px] px-2 py-0.5 rounded border border-slate-200">P3 Routine</span>
                  </td>
                  <td className="py-3.5 px-3 font-bold text-slate-900">1,240 Calls</td>
                  <td className="py-3.5 px-3 font-semibold text-slate-700">32s</td>
                  <td className="py-3.5 px-3 font-bold text-slate-600">+4.1%</td>
                  <td className="py-3.5 px-3 text-right">
                    <span className="text-slate-500 hover:text-slate-800 font-semibold text-[11px] cursor-pointer">Inspect</span>
                  </td>
                </tr>
        ...
        <div className="lg:col-span-4 bg-white border border-slate-200 rounded-xl p-5 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">STRATEGIC BRAND DOSSIER</div>
              <div className="font-extrabold text-sm text-slate-900">CardioCare 20mg</div>
            </div>
          ...
          <div className="bg-slate-50 rounded-lg p-3 space-y-2 border border-slate-200">
            ...
            <div className="space-y-1.5 text-[11px]">
              <div className="flex items-center justify-between">
                <span className="text-slate-600">Slide 1: Clinical Efficacy & Lipid Lowering</span>
                <span className="font-bold text-slate-800">42s (54%)</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                <span className="text-slate-600">Slide 2: Dual Action Safety Profile</span>
                <span className="font-bold text-slate-800">24s (31%)</span>
              </div>
              <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden">
              ...
              <div className="flex items-center justify-between">
                <span className="text-slate-600">Slide 3: Dosage & Bioequivalence Data</span>
                <span className="font-bold text-slate-800">12s (15%)</span>
              </div>
              <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden">
          ...
          <div className="space-y-2">
            <div className="text-xs font-bold text-slate-800">Target Specialist Detailing Reach</div>
            <div className="space-y-1.5 text-[11px]">
              <div className="flex items-center justify-between">
                <span className="text-slate-600 font-medium">Interventional Cardiologists</span>
                <span className="font-bold text-emerald-700">1,480 / 1,520 (97.4%)</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-600 font-medium">Consulting Physicians (MD Med)</span>
                <span className="font-bold text-emerald-700">1,240 / 1,350 (91.8%)</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-600 font-medium">Diabetologists & Endos</span>
                <span className="font-bold text-amber-700">700 / 920 (76.1%)</span>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-slate-100 pt-3 space-y-2 text-[11px]">
            <div className="text-xs font-bold text-slate-800">Chemist Stockist Liquidation</div>
            <div className="bg-emerald-50/60 border border-emerald-200 rounded-lg p-2.5 text-slate-700 space-y-1">
              <div className="flex items-center justify-between font-semibold">
                <span>Stockist Availability Index:</span>
                <span className="text-emerald-800 font-bold">96.8% Stocked</span>
              </div>
              <div>Secondary Sales Velocity: <strong className="text-slate-900">₹ 42.8 Lakhs / mo</strong> (+18.2% vs target). Zero stock-outs reported across 28 Depots.</div>
            </div>
          </div>
      ...
      <div className="bg-orange-50/70 border border-orange-200 rounded-xl p-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xs font-bold text-slate-900">UCPMP Standard • Medical Detailing & Scientific Justification</div>
            <div className="text-[11px] text-slate-600">All visual aid detailing slides must feature approved Indian Drug Regulatory monograph numbers and approved indication literature. Promotional claims without clinical trial citations are automatically flagged.</div>
          </div>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          <button className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold px-3 py-1.5 rounded-lg text-xs">Clinical Monograph Audit</button>
