...
<div className="flex items-center gap-4 pl-3 border-l border-border-subtle">
...
<div>
<h2 className="text-xl font-extrabold text-text-primary tracking-tight flex items-center gap-4">
...
<button className="px-3 py-2 bg-surface-card border border-border-subtle text-text-secondary hover:bg-surface-subtle rounded-lg text-xs font-semibold shadow-sm flex items-center gap-4 transition-all">
...
<div className="flex flex-wrap items-center justify-between border-b border-border-subtle gap-4">
<div className="flex items-center gap-6 text-xs font-semibold">
<button className="pb-3 text-[#b43403] border-b-2 border-[#b43403] flex items-center gap-4">
...
<button className="pb-3 text-text-secondary hover:text-text-primary flex items-center gap-4 transition-colors">
...
{/* Mini stats ribbon */}
<div className="grid grid-cols-3 gap-4 my-3 p-2 bg-surface-subtle rounded-lg text-center">
<div>
