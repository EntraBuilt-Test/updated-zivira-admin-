...
// (AdminSetup.aspx) exactly: a single two-column bordered box (Plan/DCR/
// Approval/Delayed/Auto-Post/Based-on-TP setup on the left, DCR-Entry/
// Doctor/Chemists/Stockists setup on the right), followed by a "Tour Plan
// Setup" pair of boxes (TP start/end date table + Tour Plan Based System
// choice with per-designation Approval Needed), and an "Additional Setup
// (Baselevel & Managers)" pair of DCR Entry Mode / Display Mode matrices.
// One bottom Save/Clear pair persists the whole document via
// CompanyConfigModel (getAdminSetting/saveAdminSetting), same pattern as
// the other single-document admin screens in this app.
      ...
      <TwoColumnBox
        left={
          <>
            ...
            <CompactFieldRow label="Doctor with Multiple Plan(s) Allowed">
