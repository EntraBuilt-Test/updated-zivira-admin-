...
const tabSlugMap: Record<string, string> = {
  ...
  "alerts": "alerts",
  "executive": "executive",
  "products-discussed": "bi-reports",
  "visit-frequency": "bi-reports"
};
...
export const adminTabMeta: Record<string, { eyebrow: string; title: string; description: string }> = {
  ...
  "products-discussed": {
    ...
    description: "Products discussed per doctor, derived from field DCR records"
  },
  "visit-frequency": {
    eyebrow: "BI Reports",
    title: "Visit Frequency",
    description: "Doctor visit frequency, derived from field DCR records"
  }
};
