  ...
  node("Division Dashboard", "division-dashboard", "division", [
    ...
    node("Navigation Tabs", "division-navigation-tabs", "division", [
      ...
      node("Options", "division-options", "division", [
        ...
        node("App Setup", "app-setup", "division", [node("Call Feedback Creation", "call-feedback", "division"), node("Call Remarks Templates", "call-remarks-templates", "division"), node("Notification Message", "notification-message", "division"), node("Gps/Geo Fence User Allocation", "gps-geofence-tagg-deletion", "division"), node("Geo Tag Deletion", "geo-tag-deletion", "division"), node("Dynamic App Link", "dynamic-app-link", "division")]),
